...
public class PremiumWinCommand extends Command {
    public PremiumWinCommand() {
        super("cmd_premium_win", Emulator.getTexts().getValue("commands.keys.cmd_premium_win").split(";"));
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(PremiumWinCommand.class);
        ...
        if (gameClient.getHabbo().getHabboInfo().getCurrentRoom() != null ) {
            if (params.length == 2) {
                ...
                if (habbo == null) {
                    ...
                    String data = "ChoosePremiumPrizeView/show";
