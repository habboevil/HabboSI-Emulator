...
public class WinCommand extends Command {
    public WinCommand() {
        super("cmd_win", Emulator.getTexts().getValue("commands.keys.cmd_win").split(";"));
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(WinCommand.class);
        ...
        if (gameClient.getHabbo().getHabboInfo().getCurrentRoom() != null ) {
            if (params.length == 2) {
                ...
                if (habbo == null) {
                    ...
                    String data = "ChoosePrizeView/show";
