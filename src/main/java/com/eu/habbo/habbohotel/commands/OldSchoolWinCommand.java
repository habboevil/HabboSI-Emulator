...
public class OldSchoolWinCommand extends Command {
    public OldSchoolWinCommand() {
        super("cmd_win", Emulator.getTexts().getValue("commands.keys.cmd_oldschool_win").split(";"));
    }

    private static final Logger LOGGER = LoggerFactory.getLogger(OldSchoolWinCommand.class);
        ...
        if (gameClient.getHabbo().getHabboInfo().getCurrentRoom() != null ) {
            if (params.length == 2) {
                ...
                if (habbo == null) {
                    ...
                    String data = "ChooseOldSchoolPrizeView/show";
