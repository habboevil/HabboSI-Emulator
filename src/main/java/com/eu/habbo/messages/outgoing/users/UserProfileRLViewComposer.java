...
public class UserProfileRLViewComposer extends MessageComposer {
    private static final Logger LOGGER = LoggerFactory.getLogger(UserProfileRLViewComposer.class);

    private final HabboInfo habboInfo;
    private Habbo habbo;
    private GameClient viewer;

    public UserProfileRLViewComposer(HabboInfo habboInfo, GameClient viewer) {
        this.habboInfo = habboInfo;
        this.viewer = viewer;
    }

    public UserProfileRLViewComposer(Habbo habbo, GameClient viewer) {
        this.habbo = habbo;
    ...
    protected ServerMessage composeInternal() {
        ...
        this.response.init(Outgoing.UserProfileRLViewComposer);
